---
title: "Subjective Wellbeing, Social Interactions and Ethnic Identity Amoung European Countries"
...
abstract: "This report aims to examine section C; Subjective well-being, social exclusion, religion, national and ethnic identity on the 2018 European Social Survey (ESS). It discusses the survey methodology and examines aspects including happiness, social interactions, national attachment and religion along with their correlation to European countries.  As an extension, a sample questionnaire is also included to further explore the impact of age and gender on the subjective-wellbeing."
output:
...
The data for the exploration is obtained from the European Social Survey website [@ESSAboutCitation], the survey is conducted every 2 years and we will be using the 2018 version which is the ninth round of the ESS for our exploration. The dataset contains the responds from 31 European countries, namely Albania, Austria, Belgium, Bulgaria, Croatia, Cyprus, Czechia, Denmark, Estonia, Finland, France, Germany, Hungary, Iceland, Ireland, Italy, Latvia, Lithuania, Montenegro, Netherlands, Norway, Poland, Portugal, Romania, Serbia, Slovakia, Slovenia, Spain, Sweden, Switzerland and United Kingdom [@ESSData]. The survey focus on many different aspects such as media and social trust, politics, subjective well-being, social exclusion, religion, national & ethnic identity, timing of life, gender, year of birth and household grid, socio-demographics, justice and fairness, human values, administrative variables and sample design variables [@ESSData]. 

For the exploration below, we will focus on the subjective well-being, social exclusion, religion, national & ethnic identity. We will look into a few sections of the survey and try to see if there is any interesting pattern that can be observed. We will analyse their level of happiness and social activeness, variable **happy** & **sclmeet**, to see if there is any difference between different countries, for example we want to find out why a specific country will have such low level of happiness. Also we will look into the statistics on their national identity and religion, variable **atchctr**, **atcherp**, **rlgdnm** & **rlgdnm**, to see what their self identifications and denomination belongings are.
...
\newline* A1 – A6: Media use; Internet use; social trust.
\newline* B1 – B43: Politics including political interest, trust, electoral and other forms of participation, party allegiance, socio-political orientations, immigration.
\newline* C1 – C42: Subjective wellbeing, social exclusion, crime, religion, perceived discrimination, national and ethnic identity, test questions (political sentiments), vote intention in EU referendum.
\newline* F1 – F61: Socio-demographic profile including household composition, sex, age, marital status, type of area, education & occupation of respondent, partner, parents, union membership, income, and ancestry.
\newline* H: Human values scale.
\newline* I: Test Questions (social situation and reaction)
...
Furthermore, there are also some questions which require a binary response (yes and no) to avoid any ambiguity in the responses. For example, question C13 and C18 (refer to table \@ref(tab:subjectiveQuestionsTable)) whether the respondent considers themselves to be religious and whether they would describe themselves a member of a group that is discriminated against in their country respectively. Although a yes/no style question removes any ambiguity it might raise additional questions when the respondent does not fully match the criteria for the provided possible responses. In the case of question C13, if someone is religious sometimes, they might consider themselves somewhere in between the “yes” and “no” options. But given the current responses of “yes”, “no” “refusal” and “Don’t know”, they might lean towards selecting “Don’t know” because they don’t see an option that best describes their response. [@YesNoQuestionsCitation].
...
# Discussion based on our findings
...
## Social Interactions on Quality of Life

Ones quality of life is a strong indication for their social wellbeing, one aspect used to measure this is using social interactions among friends, relatives and coworkers. Aside from just socializing just as a way to fulfill human needs, more frequent and profound interactions are associated with better health and improved social networking such as finding jobs. In particular, having a form of social support in times of need; whether that is family or friends is a key factor in describing happiness. Social interactions is one of six indicators used by United Nations’ World happiness report in accessing a person’s happiness and by extension their social wellbeing [@QualityOfLifeCitation]. This supports the findings in figure \@ref(fig:happinessMap) and \@ref(fig:socialPieChart), showing that the majority of European individuals engage in social interactions at least one per week which correlates to the vast majority of those countries with a high happiness score as determined by ESS.

Furthermore, social interactions have been shown to reduce the negative effects of stress in an individual and individuals with frequent social interactions with their friends and family have higher subjective wellbeing [@SubjectiveWellbeingPaperCitation]. It is important to note that less than one third of Denmark’s adult population gets together with family at least once a week [@SubjectiveWellbeingPaperCitation] but even then, Denmark has the highest happiness score among all the countries in ESS, see figure \@ref(fig:happinessMap). This finding is not at all surprising since Denmark, including the other Baltic countries have very well-established social programs including high minimum wages and free healthcare to name a few.

The data explored here is from 2018 data and social interactions and been restricted for a few years due the COVID-19 pandemic and lockdown. It is unclear as to how this has impacted the social wellbeing of the European countries because there is no data available as of yet. But given the studies by the United Nations [@QualityOfLifeCitation], we would expect the overall wellbeing to go down because of this prolonged period of no social interactions. That being said, there is the possibility of video calls among groups of people, but its impact has yet to be determined as there is no recent data present by ESS.

## waning Emotional Attachment to European Identity
From the results in Figure 3, there’s been waning attachments among citizens of Europe to identify themselves as Europeans and stronger sentiments to their own countries in recent years. With the United Kingdom’s formal withdrawal European Union and raising advocacy for withdrawal in other member states, it is no surprise why the European identity is diminishing. 

We can take a closer look at why the United Kingdom withdrew from the European Union. More commonly known as “Brexit” [@Brexit], sovereignty was one of the prominent reasons for this decision as the rise of nationalism is being spread worldwide. There’s growing mistrust in EU where many believed that such an institution no longer serves a purpose and takes away control from individual countries. The Europe immigration crisis was a trigger for this as the people of UK wanted to regain control over their own immigration policy and maintain their borders.

Greece is another country that was highly speculated to leave EU and coined the term “Grexit”, mainly due to its government debt crisis that would externally impose its membership from EU. [@Grexit] This would also mean that Greece would switch their currency from Euro back to Drachma. This reveals the economical instability that the EU faces, and how the EU failed to address problems in globalization and domestic narratives. 

Sovereignty is increasingly desired amidst immigration and economic struggles as seen as situations developed towards Brexit and potentially even Grexit. With rising disputes that question what purpose these multinational institutes serve, citizens begin to be divided in their shared identity as Europeans. 


# Survey Privacy and Ethics

It’s of upmost importance to protect the interests of subjects in any statistical research. All participation in the ESS is voluntary where any questions are answered at the respondent’s discretion and may be stopped at any time without explanation. All collected information are treated with strict confidentiality in accordance with the EU’s General Data Protection Regulation (GDPR) and national data protection laws. The fieldwork organization will remove all associations of personal information such as name and address from survey responses then purging said personal information when the ESS data is published (no later than June 2020). The ESS data will be securely stored for an indefinite period and made available for future scientific research regarding Europe social sciences. While there is a possibility certain combination of information can identify a participant, the ESS makes every effort to avoid that possibility in the results of the survey and any following publications. 
The ESS also subscribes to the Declaration on Professional Ethics of the International Statistical Institute. [@EthicsDeclaration] There are 12 ethical principles that are stated as follows during the pursuit of public interest:
\newline* Pursuing Objectivity
\newline* Clarifying Obligations
\newline* Assessing Alternatives Impartially
\newline* Conflicting Interests
\newline* Avoiding Pre-empted Questions
\newline* Guarding Privileged Information
\newline* Exhibiting Professional Competence
\newline* Maintaining Confidence in Statistics
\newline* Exposing and Reviewing Methods and Findings
\newline* Communicating Ethical Principles
\newline* Bearing Responsibility for the Integrity of the Discipline
\newline* Protecting the Interests of Subjects
\newline ESS has put a substantial amount of effort to oblige to this declaration and its principles. Transparent objectives, flow charts of its survey design process, sample guidelines detailing their target population and methods, and comprehensive lists of contacts are among the many commitments they have made to ensure ethical use of ESS data.
...
happiness <- 
  ...
  coord_flip() +
  labs(x="Countries", y="Level of Happiness", title = "Level of happiness of people in European countries") 
